...
const menuItems = [
  ...
  { name: "Billing", icon: CurrencyDollarIcon, path: "/user/billing" },
  { name: "Account Log", icon: ClockIcon, path: "/user/account-log" },
  {
...
<template>
  ...
  >
    ...
    <div class="p-6 border-b border-gray-100">
      <h2 class="text-xl font-bold text-gray-900">CleanConnect</h2>
    ...
    <nav class="flex-1 pt-4 overflow-y-auto">
      ...
      >
        <component
          ...
          :class="[
            'h-5 w-5 mr-3',
            currentPage === item.name ? 'text-green-600' : 'text-gray-400',
          ]"
        />
    ...
    <div class="p-6 border-t border-gray-100">
      <button
        @click="handleLogout"
        class="w-full bg-green-500 hover:bg-green-600 text-white py-2.5 px-4 rounded-lg transition-all duration-200 flex items-center justify-center gap-2 font-medium shadow-sm hover:shadow-md transform hover:-translate-y-0.5"
      >
